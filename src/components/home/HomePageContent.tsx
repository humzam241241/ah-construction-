    ...
    <>
      ...
      <section className="bg-white border-b border-gray-100" aria-label="Company statistics">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <StaggerContainer
            className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x md:divide-gray-200"
            staggerDelay={150}
            animation="scale-up"
            duration={800}
          >
      ...
      <section className="py-14 bg-white border-y border-gray-100" aria-labelledby="client-types-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <ScrollReveal animation="brick-drop" duration={800}>
      ...
      <section className="py-20 bg-gray-50" aria-labelledby="services-preview-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <ScrollReveal animation="brick-drop" duration={900} delay={100}>
          ...
          >
            {services.map((service) => (
              <Link
                key={service.title}
                href={service.href}
                className="group bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#e8a020]/30 hover:-translate-y-1 transition-all duration-300"
              >
                <div className="w-14 h-14 bg-[#1a3c5e]/10 rounded-xl flex items-center justify-center text-[#1a3c5e] mb-5 group-hover:bg-[#1a3c5e] group-hover:text-white group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  {service.icon}
                </div>
          ...
          <ScrollReveal animation="fade-up" delay={200} className="text-center mt-10">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 px-6 py-3 border-2 border-[#1a3c5e] text-[#1a3c5e] font-semibold rounded-lg hover:bg-[#1a3c5e] hover:text-white hover:scale-105 transition-all duration-300"
            >
              View All Services
      ...
      <section className="py-20 bg-white" aria-labelledby="why-us-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {reasons.map((reason) => (
              <div key={reason.title} className="flex gap-4 p-5 rounded-xl border border-gray-100 hover:border-[#1a3c5e]/20 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                <div className="w-12 h-12 bg-[#e8a020]/10 rounded-xl flex items-center justify-center text-[#e8a020] shrink-0 group-hover:scale-110 transition-transform">
                  {reason.icon}
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {featuredProjects.map((project) => (
              <div key={project.title} className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                <div className="h-48 bg-gradient-to-br from-[#1a3c5e] to-[#0f2540] flex items-end p-5 relative overflow-hidden">
                  {/* Animated background pattern */}
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-4 right-4 w-24 h-24 border-2 border-white/30 rounded-lg rotate-12 group-hover:rotate-45 transition-transform duration-700" />
                    <div className="absolute bottom-8 right-12 w-16 h-16 border-2 border-white/20 rounded-full group-hover:scale-150 transition-transform duration-700" />
                  </div>
                  <span className="relative inline-block bg-[#e8a020] text-white text-xs font-semibold px-3 py-1 rounded-full">
                    {project.category}
                  </span>
                </div>
                <div className="p-5">
      ...
      {/* CTA Block */}
      <section className="py-20 bg-[#1a3c5e] relative overflow-hidden" aria-labelledby="cta-heading">
        {/* Animated background decoration */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-12 -right-12 w-64 h-64 bg-[#e8a020]/5 rounded-full blur-3xl animate-pulse" />
          <div className="absolute -bottom-12 -left-12 w-48 h-48 bg-[#e8a020]/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <ScrollReveal animation="scale-up" delay={400}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#e8a020] text-white font-semibold rounded-lg hover:bg-amber-500 hover:scale-105 hover:shadow-xl hover:shadow-[#e8a020]/30 transition-all duration-300 text-base"
              >
                Get a Free Quote
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 hover:border-white/60 transition-all duration-300 text-base"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
